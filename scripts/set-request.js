...
async function main() {
  ...
  const CourseVerifierAddress = "0x1C30DC7674e5Fd4f6154152E018b92ff29E66B41"

  let CourseVerifier = await hre.ethers.getContractAt("CourseVerifier", CourseVerifierAddress)
  ...
  try {
    await CourseVerifier.setZKPRequest(
        requestId,
        validatorAddress,
        query.schema,
        query.claimPathKey,
